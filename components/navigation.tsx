...
import { NeonTrailing } from "./neon-trailing"
...
export default function Navigation({ themeToggle, isDark }: NavigationProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background backdrop-blur-md border-b border-border texture-axiom ">
      <div className="bg-linear-to-r from-[#000000ff] via-[#00000000] to-[#000000ff] flex flex-1 w-full justify-between gap-20">
        <NeonTrailing />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 opacity-100 flex-1">
          <div className="flex items-center justify-between h-20 z-999">
            {/* Logo */}
